...
import (
	...
	"github.com/tatuya-web/go_todo_app/clock"
	"github.com/tatuya-web/go_todo_app/entity"
	"github.com/tatuya-web/go_todo_app/store"
	"github.com/tatuya-web/go_todo_app/testutil/fixture"
)
...
func TestJWT_GetToken(t *testing.T) {
	t.Parallel()

	c := clock.FixedClocker{}
	want, err := jwt.NewBuilder().
		JwtID(uuid.New().String()).
		Issuer(`github.com/tatuya-web/go_todo_app`).
